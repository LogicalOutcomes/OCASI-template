...
$(document).ready(function()
{
    ...
    // Postion the subnav        
    if( $('.progress .progress-bar').length <= 0 && $('#langchanger').length <= 0 ){
        $('.sub-navigation').addClass('sub-navigation-top');
    } else if( $('.progress .progress-bar').length > 0 && $('#langchanger').length > 0 ){
        $('.sub-navigation').addClass('sub-navigation-top-language-progress');
    } else if( $('.progress .progress-bar').length > 0 ){
        $('.sub-navigation').addClass('sub-navigation-top-progress');
    } else if( $('#langchanger').length > 0 ){
        $('.sub-navigation').addClass('sub-navigation-top-language');
    }
